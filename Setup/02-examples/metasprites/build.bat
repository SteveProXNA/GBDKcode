...
%GBDK_WIN%/bin/png2asset sprite.png -sh 48 -spr8x16 -c sprite.c 
%GBDK_WIN%/bin/lcc -Wa-l -Wl-m -Wl-j -c -o metasprites.o metasprites.c
%GBDK_WIN%/bin/lcc -Wa-l -Wl-m -Wl-j -c -o sprite.o sprite.c
%GBDK_WIN%/bin/lcc -Wa-l -Wl-m -Wl-j -o output.gb metasprites.o sprite.o
